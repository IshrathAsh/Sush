...
import os
import math
import whisperx  # Add WhisperX import
...
def transcribe_audio_with_timestamps(audio_path):
    print(f"Transcribing audio from '{audio_path}' using WhisperX (offline)...")
    try:
        model = whisperx.load_model("base", device="cpu")  # Use "cuda" if you have a GPU
        ...
        print(f"An error occurred during WhisperX transcription: {e}")
        return []
